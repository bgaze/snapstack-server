...
export const DEFAULT_POLICY = {
  ...
  quality: 0.85, // lossy quality for webp/jpg, 0..1
...
export async function readConfig() {
  ...
  // Back-compat: the field was renamed maxEdge → maxWidth (pre-1.0). Honor an old
  // config so a rename never silently resets the whole policy to defaults.
  if (stored.maxWidth == null && stored.maxEdge != null) stored.maxWidth = stored.maxEdge;
