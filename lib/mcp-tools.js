...
//   - stdio                  : snapstack-mcp.js, spawned by the client
// Keeping it free of any transport import means the stdio bin does not pull in
// the HTTP transport (and vice-versa).
